...
module.exports = function (content) {
	...
	var hmr = [
		...
		"	module.hot.accept(" + loaderUtils.stringifyRequest(this, "!!" + this.request) + ", function() {",
		"		var newContent = require(" + loaderUtils.stringifyRequest(this, "!!" + this.request) + ");",
		"",
	...
	return [
		...
		"var update = require(" + loaderUtils.stringifyRequest(this, "!" + path.join(__dirname, "lib", "addStyles.js")) + ")(exports, options);",
		"",
		options.hmr ? hmr : ""
	].join("\n");
};
